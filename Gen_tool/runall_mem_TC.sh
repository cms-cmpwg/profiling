...
if [ "X$RUNALLSTEPS" != "X" ]; then
  if [ -f step1_igprof.py ]; then
    ...
    timeout $TIMEOUT igprof -mp -z -t cmsRunTC -o ./igprofMEM_TC_step1.gz -- cmsRunTC step1_igprof.py -j step1_igprof_mem_TC_JobReport.xml >& step1_igprof_mem_TC.log
  ...
  if [ -f step2_igprof.py ]; then
    ...
    timeout $TIMEOUT igprof -mp -z -t cmsRunTC -o ./igprofMEM_TC_step2.gz -- cmsRunTC step2_igprof.py -j step2_igprof_mem_TC_JobReport.xml >& step2_igprof_mem_TC.log
    rename_igprof igprofMEM_TC_step1
  else
...
if [ -f step3_igprof.py ]; then
    ...
    timeout $TIMEOUT igprof -mp -z -t cmsRunTC -o ./igprofMEM_TC_step3.gz -- cmsRunTC step3_igprof.py -j step3_igprof_mem_TC_JobReport.xml >& step3_igprof_mem_TC.log
...
if [ -f step4_igprof.py ]; then
    ...
    timeout $TIMEOUT igprof -mp -z -t cmsRunTC -o ./igprofMEM_TC_step4.gz -- cmsRunTC step4_igprof.py -j step4_igprof_mem_TC_JobReport.xml >& step4_igprof_mem_TC.log
...
if [ $(ls -d step5*.py | wc -l) -gt 0 ]; then
    ...
    timeout $TIMEOUT igprof -mp -z -t cmsRunTC -o ./igprofMEM_TC_step5.gz -- cmsRunTC step5_igprof.py -j step5_igprof_mem_TC_JobReport.xml >& step5_igprof_mem_TC.log
