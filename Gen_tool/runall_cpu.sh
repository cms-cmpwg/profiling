...
case $SCRAM_ARCH in
	el8*)
	scram setup $(grep 2.17 /cvmfs/cms-ib.cern.ch/sw/x86_64/latest/el8_amd64_gcc12/cms/cmssw-tool-conf/*/tools/selected/tensorflow.xml | cut -d: -f1 | tail -1);;
        el9*)
	scram setup $(grep 2.17 /cvmfs/cms-ib.cern.ch/sw/x86_64/latest/el9_amd64_gcc12/cms/cmssw-tool-conf/*/tools/selected/tensorflow.xml | cut -d: -f1 | tail -1);;
esac
#scram b ToolUpdated
scram tool info tensorflow
