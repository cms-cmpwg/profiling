...
if ( echo $outname | grep -q '136.') || ( echo $outname | grep -q '141.' ) ; then
  ...
  echo "${steps[0]} --customise Validation/Performance/JeProfInfo.customise  --customise PerfTools/AllocMonitor/ModuleAllocMonitor.customise --customise_commands \"process.options.numberOfThreads = 1\" --python_filename=step2_allocmon.py" >>cmd_am.sh
  ...
  echo "${steps[1} --customise Validation/Performance/JeProfInfo.customise  --customise PerfTools/AllocMonitor/ModuleAllocMonitor.customise --customise_commands \"process.options.numberOfThreads = 1\" --python_filename=step3_allocmon.py" >>cmd_am.sh
  ...
  echo "${steps[2]} --customise Validation/Performance/JeProfInfo.customise  --customise PerfTools/AllocMonitor/ModuleAllocMonitor.customise --customise_commands \"process.options.numberOfThreads = 1\" --python_filename=step4_allocmon.py" >>cmd_am.sh
else
  ...
  echo "${steps[0]} --customise Validation/Performance/JeProfInfo.customise  --customise PerfTools/AllocMonitor/ModuleAllocMonitor.customise --customise_commands \"process.options.numberOfThreads = 1\" --python_filename=step1_allocmon.py" >>cmd_am.sh
  ...
  echo "${steps[1]} --customise Validation/Performance/JeProfInfo.customise  --customise PerfTools/AllocMonitor/ModuleAllocMonitor.customise --customise_commands \"process.options.numberOfThreads = 1\" --python_filename=step2_allocmon.py" >>cmd_am.sh
  echo "perl -p -i -e 's!/store/relval!root://eoscms.cern.ch//store/user/cmsbuild/store/relval!g' step2_allocmon.py" >>cmd_am.sh
  ...
  echo "${steps[2]} --customise Validation/Performance/JeProfInfo.customise  --customise PerfTools/AllocMonitor/ModuleAllocMonitor.customise --customise_commands \"process.options.numberOfThreads = 1\" --python_filename=step3_allocmon.py" >>cmd_am.sh
  ...
  echo "${steps[3]} --customise Validation/Performance/JeProfInfo.customise  --customise PerfTools/AllocMonitor/ModuleAllocMonitor.customise --customise_commands \"process.options.numberOfThreads = 1\" --python_filename=step4_allocmon.py" >>cmd_am.sh
# check for 5th step
if ( echo ${!steps[@]} | grep -q 4 );then
  ...
  echo "${steps[4]} --customise Validation/Performance/JeProfInfo.customise  --customise PerfTools/AllocMonitor/ModuleAllocMonitor.customise --customise_commands \"process.options.numberOfThreads = 1\" --python_filename=step5_allocmon.py" >>cmd_am.sh
  fi
fi
chmod +x cmd_am.sh
chmod +x cmd_ts.sh
