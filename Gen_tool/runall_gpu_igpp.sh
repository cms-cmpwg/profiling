...
if [ "X$RUNALLSTEPS" != "X" ]; then
  if [ -f step1_gpu_igprof.py ]; then
    ...
    igprof -pp -z -t cmsRun -o ./igprofCPU_step1.gz -- cmsRun step1_gpu_igprof.py -j step1_gpu_igprof_pp_JobReport.xml >& step1_gpu_igprof_pp.log
  ...
  if [ -f step1_gpu_igprof.py ]; then
    ...
    igprof -pp -z -t cmsRun -o ./igprofCPU_step2.gz -- cmsRun step2_gpu_igprof.py -j step2_gpu_igprof_pp_JobReport.xml >& step2_gpu_igprof_pp.log
...
if [ -f step3_gpu_igprof.py ]; then
  ...
  igprof -pp -z -t cmsRun -o ./igprofCPU_step3.gz -- cmsRun step3_gpu_igprof.py -j step3_igprof_pp_JobReport.xml >& step3_gpu_igprof_pp.log
...
if [ -f step4_gpu_igprof.py ]; then
  ...
  igprof -pp -z -t cmsRun -o ./igprofCPU_step4.gz -- cmsRun step4_gpu_igprof.py -j step4_igprof_pp_JobReport.xml >& step4_gpu_igprof_pp.log
...
if [ -f step5_gpu_igprof.py ]; then
  ...
  igprof -pp -z -t cmsRun -o ./igprofCPU_step5.gz -- cmsRun step5_gpu_igprof.py -j step5_igprof_pp_JobReport.xml >& step5_gpu_igprof_pp.log
